  ...
  const onSubmit = (e) => {
    ...
    if (saved != "") {
      window.localStorage.setItem(
        "snippets",
        JSON.stringify([...JSON.parse(saved), formData])
      );
    } else {
      window.localStorage.setItem("snippets", JSON.stringify([formData]));
    }
  };

  return (
    <form className="flex flex-col gap-4 w-400px" onSubmit={(e) => onSubmit(e)}>
